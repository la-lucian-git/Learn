"""
Scenario:
    - Your client has a subscription to a trading newsletter.
    ...
    - The client tracks their trades in a spreadsheet and every week they have to copy the
        trades from the email into their trading spreadsheet.
...
Exercise:
    * Create a program that will output a file with a list of trades from the email body.
...
result_file_path = "C:\\Users\\Duke\\Documents\\Learn" \
                   "\\Python From Scratch & Selenium WebDriver QA Automation 2022\\exercises\\output.csv"
all_trades_raw = """
PEP Short $153.68
Stop Loss $156.98
Target $146.10
